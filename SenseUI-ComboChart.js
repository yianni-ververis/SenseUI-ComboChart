...
define(["qlik", "jquery", 'css!./SenseUI-ComboChart.css', './SenseUI-ComboChart-options', "./d3.v3.min", './d3-tip', './SenseUI-ComboChart-css'], function (qlik, $, css, options, d3) {
	...
	me.paint = function ($element, layout) {
		...
		var yAxisMax = d3.max(vars.data, function (d) {
			return Math.max(d.measureNum, d.measureNum2 ? d.measureNum2 : 0, d.measureNum3 ? d.measureNum3 : 0, d.measureNum4 ? d.measureNum4 : 0, d.measureNum5 ? d.measureNum5 : 0, d.measureNum6 ? d.measureNum6 : 0);
		});
		var yAxisMin = d3.min(vars.data, function (d) {
			return Math.min(d.measureNum, d.measureNum2 ? d.measureNum2 : 0, d.measureNum3 ? d.measureNum3 : 0, d.measureNum4 ? d.measureNum4 : 0, d.measureNum5 ? d.measureNum5 : 0, d.measureNum6 ? d.measureNum6 : 0);
		});
